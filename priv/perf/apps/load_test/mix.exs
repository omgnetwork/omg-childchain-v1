defmodule LoadTest.MixProject do
  ...
  def application do
    [
      extra_applications: [:logger, :ex_abi, :ex_keccak, :ex_rlp, :ex_secp256k1],
  ...
  defp deps do
    [
      ...
      {:telemetry, "~> 0.4.1"},
      {:ex_plasma, git: "https://github.com/omisego/ex_plasma.git", ref: "66401508deb97983bed09ec80c22f40e62846fe1"},
