...
defmodule OMG.ChildChain.ReleaseTasks.SetBlockSubmitEveryNth do
  @moduledoc false
  @behaviour Config.Provider
  require Logger

  @app :omg_child_chain
  @config_key :block_submit_every_nth
  @env_var_name "BLOCK_SUBMIT_EVERY_NTH"
  ...
  def load(config, _args) do
    ...
    Config.Reader.merge(config, omg_child_chain: [block_submit_every_nth: config_value])
  end
