...
defmodule OMG.Status.Metric.Event do
  ...
  def name(:transaction_batch_submission), do: "transaction_batch_submission"
  def name(:transaction_batch_submission_success), do: "transaction_batch_submission_success"
  def name(:transaction_batch_submission_failed), do: "transaction_batch_submission_failed"
  def name(:transaction_batch_submission_mixed), do: "transaction_batch_submission_mixed"
